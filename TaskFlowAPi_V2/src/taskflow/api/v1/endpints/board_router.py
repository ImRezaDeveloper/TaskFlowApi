...
from src.taskflow.schemas.contract.board_schema import BoardCreate, BoardUpdate, BoardResponse
...
async def get_all_boards(  
    ...
    return await get_all_boards_service(  
        db,
        current_user.id
    )
...
async def update_board(  
    ...
    return await update_board_service(  
        db,
        board_id,
        board_data,
        current_user.id
...
async def get_tasks_in_board(  
    ...
    return await get_tasks_by_board_id_service(  
        db, 
        board_id, 
        current_user.id
    )
