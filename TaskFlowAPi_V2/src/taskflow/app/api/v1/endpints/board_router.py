...
from app.schemas.contract.board_schema import BoardCreate, BoardUpdate, BoardResponse
from app.schemas.contract.task_schema import TaskCreate, TaskResponse
